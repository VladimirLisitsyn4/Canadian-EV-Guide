...
public class leafpFrame extends JFrame {

    private JFrame f = new JFrame("Nissan Leaf SV PLUS");
    private JLabel Title = new JLabel("Nissan Leaf SV PLUS");
    private JLabel Price = new JLabel("Price: $43,098");
    ...
    private void initComponent() {
        ...
        try {
            ...
            BufferedImage img = ImageIO.read(MyFrame.class.getResource("images/Nissan_Leaf_SV_PLUS.png"));
