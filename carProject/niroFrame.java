...
public class niroFrame extends JFrame {

    private JFrame f = new JFrame("Kia Niro EV");
    private JLabel Title = new JLabel("Kia Niro EV");
    private JLabel Price = new JLabel("Price: $44,995");
    private JLabel Range = new JLabel("Range: 385km");
    private JLabel Charge = new JLabel("Charge Length: est. 9h");
    private JLabel Colours = new JLabel("Colourways: White, Black");
    ...
    private void initComponent() {
        ...
        try {
            ...
            BufferedImage img = ImageIO.read(MyFrame.class.getResource("images/Kia_Niro_EV.png"));
