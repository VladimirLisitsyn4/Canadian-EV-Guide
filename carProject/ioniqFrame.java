...
public class ioniqFrame extends JFrame {

    private JFrame f = new JFrame("Hyundai IONIQ 5");
    private JLabel Title = new JLabel("Hyundai IONIQ 5");
    private JLabel Price = new JLabel("Price: $46,951");
    private JLabel Range = new JLabel("Range: 488km");
    private JLabel Charge = new JLabel("Charge Length: est. 7h");
    private JLabel Colours = new JLabel("Colourways: White, Black, Blue, Grey");
    ...
    private void initComponent() {
        ...
        try {
            ...
            BufferedImage img = ImageIO.read(MyFrame.class.getResource("images/Hyundai_IONIQ_5.png"));
