...
public class iXM60Frame extends JFrame {

    private JFrame f = new JFrame("BMW iX M60");
    private JLabel Title = new JLabel("BMW iX M60");
    private JLabel Price = new JLabel("Price: $121,750");
    private JLabel Range = new JLabel("Range: 450km");
    ...
    private void initComponent() {
        ...
        try {
            ...
            BufferedImage img = ImageIO.read(MyFrame.class.getResource("images/BMW_iX_M60.png"));
